...
public class LogPlayer extends JComponent {
    ...
    public LogPlayer(String lcmurl) throws IOException {
        ...
        add(js, new GridBagConstraints(0, row, REMAINDER, 1, 1.0, 0.0, CENTER, HORIZONTAL, new Insets(0, 5, 0, 5), 0,
                0));
        row++;
        ...
        add(stepPanel, new GridBagConstraints(2, row, REMAINDER, 1, 1.0, 0.0, CENTER, HORIZONTAL,
    ...
    public static void main(String args[]) {
        ...
        for (optind = 0; optind < args.length; optind++) {
            ...
            if (c.equals("-h") || c.equals("--help")) {
                ...
                usage();
            } else if (logFile != null) // there should only be 1 non-flag
                                        // argument
                usage();
            else {
                logFile = c;
