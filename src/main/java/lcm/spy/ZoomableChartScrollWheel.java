...
public class ZoomableChartScrollWheel extends ZoomableChart {
            ...
            if (rightTraceFlag == false) {
                ...
                newItem.addActionListener(new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
                        ...
                        ZoomableChartScrollWheel.this.addTrace(trace, ZoomableChartScrollWheel.this.getAxisX(),
                                newAxis);
                        ZoomableChartScrollWheel.this.updateRightClickMenu();
                    }
                });
    ...
    private void dragChart(MouseEvent e) {
        ...
        if (Double.isNaN(mouseDownMinX) || Double.isNaN(mouseDownMaxX) || Double.isNaN(mouseDownMinY.get(0))
                ...
                || Double.isInfinite(mouseDownMinX) || Double.isInfinite(mouseDownMaxX)
                || Double.isInfinite(mouseDownMinY.get(0)) || Double.isInfinite(mouseDownMaxY.get(0))
                || Double.isInfinite(deltaX) || Double.isInfinite(deltaY)) {
            return;
        }

        zoom(mouseDownMinX - deltaX, mouseDownMaxX - deltaX, mouseDownMinY.get(0) + deltaY,
    ...
    public class MyMouseWheelListener implements MouseWheelListener {
        ...
        public void mouseWheelMoved(MouseWheelEvent e) {
            ...
            double xPercent = ((double) e.getX() - (double) chart.getXChartStart())
                    / (double) (chart.getXChartEnd() - chart.getXChartStart());
            double yPercent = ((double) e.getY() - (double) chart.getYChartEnd())
