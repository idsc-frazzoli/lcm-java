...
public class JImage extends JComponent {
    ...
    /**
     * Zoom, preserving the center point on the screen. (When we draw, the
     * center point may be moved in order to maximize the amount of image seen
     * on screen.)
     **/
    ...
    /*
     * public void setScale(boolean b) { scale=b; }
     */
