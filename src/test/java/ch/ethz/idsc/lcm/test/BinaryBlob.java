...
public final class BinaryBlob implements lcm.lcm.LCMEncodable {
  ...
  public static long _hashRecursive(ArrayList<Class<?>> classes) {
    if (classes.contains(ch.ethz.idsc.lcm.test.BinaryBlob.class))
      return 0L;
    classes.add(ch.ethz.idsc.lcm.test.BinaryBlob.class);
  ...
  public static ch.ethz.idsc.lcm.test.BinaryBlob _decodeRecursiveFactory(DataInput ins) throws IOException {
    ch.ethz.idsc.lcm.test.BinaryBlob o = new ch.ethz.idsc.lcm.test.BinaryBlob();
